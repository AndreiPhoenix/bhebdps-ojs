escribe("About this (about_this.js)", function() {
  it("'this' inside a method", function () {
    let person = {
      name: 'bob',
      intro: function () {
        return "Hello, my name is " + this.name; // Fill in with 'name'
      }
    }
  ...
  it("'this' on unattached function", function () {
    ...
    window.globalName = 'Peter'; // Fill in with 'globalName'
  ...
  it("'this' set explicitly", function () {
    ...
    let message = person.intro.call({name: "Frank"}); // Fill in with 'name'
